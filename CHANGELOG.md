...
## [v1.2.3]
### Changed
- Updated container image to move conda environment out of `/home`. This fixes an issue some users experienced when running the workflow with singularity: nextflow would report not being able to find programs. 
